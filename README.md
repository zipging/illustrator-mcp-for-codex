...
Reference paper: [Transfer learning enables predictions in network biology](https://www.nature.com/articles/s41586-023-06139-9). The source article is not CC BY; review the publisher's reuse terms before redistributing the original panel PNG.
...
<table>
  ...
  <tr>
    <td align="center">
      <img src="examples/geneformer/original.png" width="360" alt="Geneformer original">
    </td>
    <td align="center">
...
- [`examples/geneformer/original.png`](examples/geneformer/original.png)
